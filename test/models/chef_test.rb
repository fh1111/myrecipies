...
class ChefTest < ActiveSupport::TestCase
  ...
  def setup
    @chef = Chef.new(chefname: "jose", email: "jose@gmail.com")
  end
  ...
  test "email validation should accpet valid addresses" do
    valid_addresses = %w[user@eee.com R_TDD-DS@eee.hello.org user@example.com first.last@eee.au laure+joe@monk.cm]
